...
# run script to stage local log insight RAML file.  This extracts
# the description text from the RAML file, removing it from the RAML
# file as it stages it. It then converts this markdown to HTML and 
# stages that as an overview for the API.
